...
export default function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      >
        <img
          src={`https://ik.imagekit.io/jag4jmnvb/thumbnail.png?updatedAt=1742489029585`}
          alt={thumbnailAlt}
          width={1920}
          height={1080}
          className="w-full rounded-md border shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8]"
        />
        <div className="absolute inset-0 flex scale-[1] items-center justify-center rounded-2xl transition-all duration-200 ease-out group-hover:scale-100">
